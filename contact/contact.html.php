<section>
    ...
    <!-- page body -->
    <div class="container">
        <form actin="" method="post" role="form">
            <!--Title-->
            <div class="row form-group">
                ...
                <div class="col-md-5">
                    <input type="radio" name="greeting" value="male">Mr.
                    <input type="radio" name="greeting" value="female">Mrs.
                </div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-5">
                    ...
                    <select name="question_ta">
                        <option value="">About What?</option>
            ...
            <div class="row form-group">
                <div class="col-md-3">
                    <p>Question<span color="red">*</span></p>
                </div>
                <div class="col-md-5">
